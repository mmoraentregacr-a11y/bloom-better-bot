...
const AdminPedidos = () => {
  ...
  return <PageLayout><main className="container pt-32 pb-24 min-h-[70vh]">
    <header className="mb-9 flex flex-col md:flex-row md:items-end justify-between gap-5"><div><p className="text-xs tracking-[.35em] uppercase text-primary">Administración</p><h1 className="font-serif text-5xl mt-2">Solicitudes de clientes</h1><p className="text-muted-foreground mt-3">Busca pedidos, revisa sus detalles y confirma las compras pagadas.</p></div><Link to="/admin/inventario" className="inline-flex items-center gap-2 border border-border px-5 py-3 text-xs uppercase tracking-wider"><Warehouse size={16}/> Inventario</Link></header>
